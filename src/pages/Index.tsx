              ...
              <CardContent className="pt-8 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <ul className="space-y-3 text-sm text-foreground leading-relaxed">
                    <li><span className="font-bold">• Индивидуальная стратегическая встреча,</span> на которой мы разбираем ваш опыт, сильные стороны и идеального клиента. Вы выходите со структурой будущего продукта, стратегией и пониманием, что именно вы можете продавать уже сейчас.</li>
                    <li><span className="font-bold">• Персональный трек на 21 день</span> — конкретные шаги, которые избавляют от хаоса и дают первые результаты: понимание клиента, проверка гипотез продукта, первые отклики и продажи.</li>
                    <li><span className="font-bold">• Три групповых встречи с разбором ваших задач.</span> Разбираем позиционирование, упаковку продукта, контент для канала, офферы.</li>

              ...
              <CardContent className="pt-8 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <ul className="space-y-3 text-sm text-foreground leading-relaxed">
                    ...
                    <li><span className="font-bold">• Персональный трек на 90 дней</span> — индивидуальный план, который строится под ваш темп, нишу, уровень, загруженность и финансовые цели.</li>
            ...
            <Card className="border-4 border-[#9A1E15] shadow-2xl bg-white hover:shadow-3xl transition-all">
              <CardContent className="pt-8 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <ul className="space-y-3 text-sm text-foreground leading-relaxed">
                    <li><span className="font-bold">• Всё, что есть в тарифе «Система продаж»</span>, плюс расширенный уровень индивидуальной работы.</li>
                    <li><span className="font-bold">• Еженедельные личные встречи,</span> на которых мы вместе глубоко прорабатываем ваш продукт, линейку, подачу, смыслы, контент, продажи, консультации, переписки, трафик и воронку. Каждый элемент доводится до состояния, когда он приносит результат.</li>

              ...
              <CardContent className="pt-8 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <ul className="space-y-3 text-sm text-foreground leading-relaxed">
                    <li>• Индивидуальная стратегическая встреча, на которой мы разбираем ваш опыт, сильные стороны и идеального клиента. Вы выходите со структурой будущего продукта, стратегией и пониманием, что именно вы можете продавать уже сейчас.</li>
                    <li>• Персональный трек на 21 день — конкретные шаги, которые избавляют от хаоса и дают первые результаты: понимание клиента, проверка гипотез продукта, первые отклики и продажи.</li>
                    <li>• Три групповых встречи с разбором ваших задач. Разбираем позиционирование, упаковку продукта, контент для канала, офферы.</li>
                    <li>• Доступ к базе знаний: основы позиционирования, структура продукта, упаковка канала, продажи, базовая воронка, бесплатные способы привлечения клиентов.</li>
                    <li>• Поддержка в общем чате: ответы на вопросы, групповые разборы, корректировка действий.</li>
                  </ul>

                  <h4 className="font-bold text-lg text-[#9A1E15] pt-2">В тест-драйв НЕ входит:</h4>
                  <p className="text-sm text-foreground leading-relaxed">
                    работа с автоворонкой, ИИ-промпты, шаблоны, нейропомощники, глубокое формирование продуктовой линейки, анализ переписок и продающих консультаций.
                  </p>
            ...
            <Card className="border-4 border-[#9A1E15] shadow-2xl bg-white hover:shadow-3xl transition-all">
              <CardContent className="pt-8 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <ul className="space-y-3 text-sm text-foreground leading-relaxed">
                    <li>• Личная стратегическая сессия, на которой мы выбираем правильную нишу, определяем вашу уникальность, формируем сильное позиционирование и собираем основу продукта.</li>
                    <li>• Персональный трек на 90 дней — индивидуальный план, который строится под ваш темп, нишу, уровень, загруженность и финансовые цели.</li>
                    <li>• Четыре групповых созвона каждый месяц — глубокие разборы ваших продуктов, контента, постов, каналов, консультаций и переписок. Это формат, где вы получаете не уроки, а индивидуальные задачи и корректировку своих реальных действий.</li>
                    <li>• Чат ежедневной поддержки — я лично отвечаю на вопросы, даю корректировки по продажам, контенту, структуре продукта, перепискам. Это сопровождение, которое ускоряет результат.</li>
                    <li>• Полный доступ ко всем модулям: позиционирование, продуктовая линейка, продающие смыслы, контент, продажи, переписки, консультации, воронки продаж, трафик, найм команды и делегирование.</li>
                    <li>• Библиотека ускорения: ИИ-промпты и нейропомощники, контент-шаблоны, шаблоны воронок, актуальные связки 2026 года, библиотека рабочих офферов.</li>
                    <li>• Приглашённые эксперты: юрист, бухгалтер, эксперт по ИИ, специалист по продажам в переписке.</li>
                    <li>• Разбор ваших материалов — офферов, консультаций, продуктов, Telegram-канала, прогревов, контента, чтобы каждая часть вашей системы работала на результат.</li>
                  </ul>
            ...
            <Card className="border-4 border-[#9A1E15] shadow-2xl bg-white hover:shadow-3xl transition-all">
              <CardContent className="pt-8 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <ul className="space-y-3 text-sm text-foreground leading-relaxed">
                    <li>• Всё, что есть в тарифе «Система продаж», плюс расширенный уровень индивидуальной работы.</li>
                    <li>• Еженедельные личные встречи, на которых мы вместе глубоко прорабатываем ваш продукт, линейку, подачу, смыслы, контент, продажи, консультации, переписки, трафик и воронку. Каждый элемент доводится до состояния, когда он приносит результат.</li>
                    <li>• Полный разбор всех ваших материалов — вы отправляете посты, переписки, консультации, офферы, воронки, сценарии. Всё проходит детальную корректировку, чтобы убрать ошибки и дать максимально сильный результат.</li>
                    <li>• Работа с уверенностью, внутренними ограничителями и подачей, чтобы убрать страхи продажи, сомнения в цене и сложности с самопрезентацией.</li>
                    <li>• Разработка продуктовой линейки от низкого до высокого чека так, чтобы вы могли продавать дороже, уверенно и экологично.</li>
                    <li>• Персональная стратегия масштабирования до 500 тысяч и выше — пошаговый план, как вырастить проект без перегруза, хаоса и бесконечного тестирования.</li>
                    <li>• Индивидуальная поддержка в приоритетном режиме — решения на любой вопрос в моменте: отправили переписку → получили корректировку, придумали оффер → получили правки, сомневаетесь → получили стратегию.</li>
                  </ul>
